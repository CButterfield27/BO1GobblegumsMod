...
// Gumballs
#include maps\gobblegum\gums\gb_perkaholic;
#include maps\gobblegum\gums\gb_wall_power;
#include maps\gobblegum\gums\gb_cache_back;
#include maps\gobblegum\gums\gb_crate_power;
#include maps\gobblegum\gums\gb_dead_of_nuclear_winter;
#include maps\gobblegum\gums\gb_extra_credit;
#include maps\gobblegum\gums\gb_gift_card;
#include maps\gobblegum\gums\gb_fatal_contraption;
#include maps\gobblegum\gums\gb_hidden_power;
#include maps\gobblegum\gums\gb_immolation_liquidation;
#include maps\gobblegum\gums\gb_kill_joy;
#include maps\gobblegum\gums\gb_licensed_contractor;
#include maps\gobblegum\gums\gb_on_the_house;
#include maps\gobblegum\gums\gb_reign_drops;
#include maps\gobblegum\gums\gb_round_robbin;
#include maps\gobblegum\gums\gb_shopping_free;
#include maps\gobblegum\gums\gb_stock_option;
#include maps\gobblegum\gums\gb_whos_keeping_score;
#include maps\gobblegum\gums\gb_wonderbar;
